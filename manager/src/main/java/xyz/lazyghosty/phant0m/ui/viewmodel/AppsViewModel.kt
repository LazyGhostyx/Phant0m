...
import xyz.lazyghosty.phant0m.ui.util.HanziToPinyin
import xyz.lazyghosty.phant0m.ui.webui.AppIconUtil
    ...
    fun loadInstalledApps() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val apps = packages.map {
                ...
                it.packageName == phant0mApp.packageName ||
...
//    }
    ...
    private fun getSavedPackageNames(): List<String> {
        return try {
            val axFile = Phant0m.newFileService()
