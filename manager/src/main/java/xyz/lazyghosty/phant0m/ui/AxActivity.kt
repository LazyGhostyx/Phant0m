package xyz.lazyghosty.phant0m.manager.ui
...
import xyz.lazyghosty.phant0m.ui.navigation.BottomBarDestination
import xyz.lazyghosty.phant0m.ui.screen.FlashIt
import xyz.lazyghosty.phant0m.ui.theme.Phant0mTheme
import xyz.lazyghosty.phant0m.ui.util.LocalSnackbarHost
import xyz.lazyghosty.phant0m.ui.util.LocaleHelper
import xyz.lazyghosty.phant0m.ui.viewmodel.ActivateViewModel
import xyz.lazyghosty.phant0m.ui.viewmodel.AppsViewModel
import xyz.lazyghosty.phant0m.ui.viewmodel.PluginViewModel
import xyz.lazyghosty.phant0m.ui.viewmodel.PrivilegeViewModel
import xyz.lazyghosty.phant0m.ui.viewmodel.SettingsViewModel
...
class AxActivity : ComponentActivity() {
    ...
    companion object {
        const val OPEN_QUICK_SHELL = "Phant0m.QUICK_SHELL"
    }
        ...
        Card(
            ...
            NavigationBar(
                ...
                BottomBarDestination.entries
                    .forEach { destination ->
                        if (!phant0mServerInfo.isRunning() && destination.needPhant0m) return@forEach
