...
class QuickShellViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var session: Phant0mCommandSession = Phant0mCommandSession()
    private var savedCommand: TextFieldValue? = null

    init {
        session.setProcessListener(object : Phant0mCommandSession.ProcessListener {
        ...
        session.setResultListener(object : Phant0mCommandSession.ResultListener {
