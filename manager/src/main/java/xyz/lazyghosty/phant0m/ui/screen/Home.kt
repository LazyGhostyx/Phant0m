package xyz.lazyghosty.phant0m.manager.ui.screen
...
import xyz.lazyghosty.phant0m.BuildConfig
import xyz.lazyghosty.phant0m.R
import xyz.lazyghosty.phant0m.ui.component.ExtraLabel
import xyz.lazyghosty.phant0m.ui.component.ExtraLabelDefaults
import xyz.lazyghosty.phant0m.ui.component.PluginCard
import xyz.lazyghosty.phant0m.ui.component.PowerDialog
import xyz.lazyghosty.phant0m.ui.component.PrivilegeCard
import xyz.lazyghosty.phant0m.ui.component.rememberConfirmDialog
import xyz.lazyghosty.phant0m.ui.component.rememberLoadingDialog
import xyz.lazyghosty.phant0m.ui.util.checkNewVersion
import xyz.lazyghosty.phant0m.ui.util.module.LatestVersionInfo
import xyz.lazyghosty.phant0m.ui.viewmodel.ActivateViewModel
import xyz.lazyghosty.phant0m.ui.viewmodel.ViewModelGlobal
                            ...
                            onReignite = {
                                scope.launch {
                                    val success = loadingDialog.withLoading {
                                        Phant0mPluginService.igniteSuspendService()
                                    }
...
fun SupportCard() {
    ...
    val githubFahrez182 = "https://github.com/fahrez182/Phant0m"
...
fun LearnCard() {
    val uriHandler = LocalUriHandler.current
    val learnPhant0m = "https://fahrez182.github.io/Phant0m"

    ElevatedCard(
        onClick = {
            uriHandler.openUri(learnPhant0m)
        }
    ) {
        Row(
            modifier = Modifier
...
fun StatusCard(
    ...
    val phant0mInfo = activateViewModel.phant0mInfo
    ...
    val uriHandler = LocalUriHandler.current
    val extraStepUrl =
        "https://fahrez182.github.io/Phant0m/guide/faq.html#start-via-wireless-debugging-start-by-connecting-to-a-computer-the-permission-of-adb-is-limited"
            ...
            when {
                isUpdating -> {
                    ...
                    Column(
                        ...
                        Text(
                            text = serverUpdatingVersion.format(phant0mInfo.getVersionCode(), VERSION_CODE),
                            style = MaterialTheme.typography.bodySmall
                        )
                    }
                }
                ...
                isRunning -> {
                    Box(
                        ...
                        Icon(
                            modifier = Modifier
                                .size(145.dp),
                            painter = painterResource(R.drawable.ic_phant0m),
                            contentDescription = null
                        )
                    }
                    Box(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            ExtraLabel(
                                text = phant0mInfo.serverInfo.getMode().label,
                        ...
                        Text(
                            text = versionPid.format(phant0mInfo.getVersionCode(), phant0mInfo.serverInfo.pid),
                            style = MaterialTheme.typography.bodySmall
                        )
                        ...
                        LaunchedEffect(Unit) {
                            while (true) {
                                time =
                                    SystemClock.elapsedRealtime() - phant0mInfo.serverInfo.starting
                                delay(1000)
                            }
                        }
    ...
    ElevatedCard(
        ...
        Column(
            ...
            InfoCardItem(
                ...
                content = phant0mInfo.serverInfo.selinuxContext,
...
fun IssueReportCard() {
    val uriHandler = LocalUriHandler.current
    val githubIssueUrl = "https://github.com/fahrez182/Phant0m/issues"
    val telegramUrl = "https://t.me/phant0m_manager"
