package xyz.lazyghosty.phant0m.manager.ui.util
...
fun checkNewVersion(): LatestVersionInfo {
    ...
    val url = "https://api.github.com/repos/fahrez182/Phant0m/releases/latest"
    // default null value if failed
    val defaultValue = LatestVersionInfo()
    runCatching {
        phant0mApp.okhttpClient.newCall(Request.Builder().url(url).build()).execute()
            .use { response ->
